...
(function () {
  ...
  function cHex(name) {
    ...
    const M = { 'черн': '#1a1a1a', 'бел': '#ffffff', 'золот': '#C9A24B', 'серебр': '#c0c0c0', 'красн': '#C8102E', 'розов': '#e79cc0', 'син': '#2456a5', 'голуб': '#7db4e0', 'зелен': '#2f7d3b', 'бирюз': '#30b3a9', 'желт': '#e8c331', 'оранж': '#e07820', 'фиолет': '#7b4397', 'пурпур': '#9b2d78', 'коричн': '#6b4423', 'кофейн': '#6f5540', 'сер': '#8a8a8a', 'беж': '#d9c4a3', 'малинов': '#c2185b', 'прозрачн': '#eef3f5', 'матов': '#dddddd', 'black': '#1a1a1a', 'white': '#ffffff', 'gold': '#C9A24B', 'silver': '#c0c0c0', 'red': '#C8102E', 'pink': '#e79cc0', 'blue': '#2456a5', 'green': '#2f7d3b', 'turquoise': '#30b3a9', 'yellow': '#e8c331', 'orange': '#e07820', 'purple': '#7b4397', 'brown': '#6b4423', 'grey': '#8a8a8a', 'gray': '#8a8a8a', 'beige': '#d9c4a3', 'clear': '#eef3f5', 'transparent': '#eef3f5', 'matte': '#dddddd' };
